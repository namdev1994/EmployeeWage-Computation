...
public class EmpWageBuilder {
	//constants
		...
		public static void main(String ards[])
		{
			...
			EmpWageBuilder dmart=new EmpWageBuilder("Dmart",20,2,10);                                       //object creation
			System.out.println("EmpWage for "+dmart.company+" is : "+dmart.empWageCalculation());          //method call
			EmpWageBuilder reliance =new EmpWageBuilder("Reliance",20,2,10);                              //object Creation 
			System.out.println("EmpWage for "+reliance.company+" is : "+reliance.empWageCalculation());  //method call
		}
}